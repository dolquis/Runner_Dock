...
M1は二段で判定します。**M1a 個人利用MVP**は所有者自身のPCとprivate repoでG1〜G5を通過した状態で、未署名の開発ビルドとして扱い、配布しません。**M1b 公開MVP**はM1aにLF-019/020/022とG6(署名・更新・uninstall・runbook)を加えた状態です。M1aの到達をM1b作業の前提にし、署名や更新基盤の準備を理由に実機検証を遅らせません。
